...
const breakfast = [
  ...
  { icon: '🥙', title: 'Балык-экмек',        meta: 'Рыба-гриль в хлебе с лодок у Галатского моста. Легенда Стамбула.', price: '~150–200 лир (~4 EUR)', img: img.balikEkmek },
  ...
  { icon: '🥧', title: 'Турецкий завтрак',   meta: 'Сыры, оливки, мёд, каймак, яйца, помидоры, хлеб. Ищите kahvaltı.', price: '~300–500 лир на двоих', img: img.turkishBreakfast },
]
const mains = [
  ...
  { icon: '🥔', title: 'Кумпир',              meta: 'Запечённая картошка с начинками. Самый вкусный — в Ортакой у Босфора.', price: '~150–200 лир · 📍 Ортакой', img: img.kumpit },
  { icon: '🦪', title: 'Мидье долма',         meta: 'Мидии с рисом и специями в ракушке. Особенно в Кадыкёй — есть стоя у лотка.', price: '~15–20 лир/шт · 📍 Кадыкёй', img: img.midye },
  { icon: '🐟', title: 'Рыба / Галатский мост', meta: 'Рестораны под мостом. Свежая рыба, вид на Босфор — туристично, но атмосферно.', price: '~300–500 лир (~7–12 EUR)', img: img.fish },
]
const sweets = [
  { icon: '🍮', title: 'Баклава',             meta: 'Слоёное тесто с орехами в сиропе. Лучшая — Güllüoğlu в Karaköy.', price: '~80–150 лир за порцию', img: img.baklava },
  { icon: '🍦', title: 'Дондурма',            meta: 'Тягучее турецкое мороженое на козьем молоке. Продавцы делают шоу.', price: '~50–100 лир', img: img.dondurma },
  { icon: '🍮', title: 'Казандиби',           meta: 'Молочный пудинг с поджаренной корочкой. Найти в muhallebici.', price: '~60–100 лир', img: img.kazandibi },
  { icon: '🧁', title: 'Сан Себастьян чизкейк', meta: 'Basque cheesecake — хит Стамбула. В кофейнях Галаты и Истикляль.', price: '~150–250 лир за кусок', img: img.cheesecake },
]
const drinks = [
